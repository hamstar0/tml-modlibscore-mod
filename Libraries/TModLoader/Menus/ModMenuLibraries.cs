...
namespace ModLibsCore.Libraries.TModLoader.Menus {
	/// <summary>
	...
	public partial class ModMenuLibraries {
		...
		public static void ApplyModBrowserFilter( string filterName, bool isFiltered, List<string> modNames ) {
			...
			//ReflectionLibraries.GetProperty<UIElement>( modBrowserUi, "UpdateFilterToggle", out filterToggle );
			//ReflectionLibraries.SetProperty( filterToggle, "CurrentState", 0 );
